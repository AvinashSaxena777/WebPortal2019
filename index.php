  ...
  <section id="intro" class="clearfix">
    <div class="container">
      ...
      <div class="intro-info">
        <h2>Provide<br><span>solution</span><br>for various problems</h2>
        <div>
          <a href="Financial.php" class="btn-get-started scrollto">Show Problems</a>
        </div>
      </div>
    ...
    <section id="login">
      <div class="container">
        ...
        <div class="modal-body">
            ...
            <p class="text-center text-muted"><a href="#register"><strong>Register now</strong></a>! It is easy and done within minutes</p>
          </div>
    ...
    <section id="register" class="section-bg">
      ...
      <div>
        <div>   
          ...
          <button type="submit" name="btn_register" class="button button-block">Register</button>
